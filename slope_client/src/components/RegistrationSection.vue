...
const handleRegistration = async () => {
  ...
  loading.value = true
  try {
    const response = await fetch('http://localhost:9194/api/v1/auth/registration', {
      method: 'POST',
      ...
      <div class="registration-box">
        ...
        <div class="registration-logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 45 45" fill="none">
            <path d="M26.2409 33.633L31.3639 35.498C33.0209 36.101 34.8379 35.375 35.6459 33.864L36.5919 34.209C35.6189 36.177 33.3389 37.17 31.2169 36.504L31.0169 36.436L24.2609 33.978L24.2519 33.974L24.2429 33.97L7.99988 28.058L8.34188 27.118L26.2409 33.633Z" fill="#63b3f5" stroke="#63b3f5"/>
            <path d="M24.8639 32.733L29.2689 26.781C29.6909 26.212 29.6519 25.434 29.2009 24.91L26.3989 22.371C26.2339 22.221 26.1889 21.984 26.2809 21.787L29.0999 17.546L30.2979 18.345C30.6079 19.873 31.1419 20.663 32.0179 21.196C32.8339 21.691 33.9089 21.941 35.2339 21.99V22.99C32.2709 22.883 30.4319 21.806 29.6609 19.916L28.7819 19.828L27.3899 21.916L29.7369 24.031C30.6519 24.855 30.8249 26.216 30.1689 27.238L25.6179 33.294M20.6019 31.208L23.8249 26.992L23.7499 26.307L20.7489 23.774C20.2659 23.366 19.9949 22.788 19.9649 22.19L21.0829 22.61L25.1239 26.158C25.3089 26.313 25.3529 26.575 25.2389 26.781L21.3149 31.759M17.6749 16.692L19.1509 15.089C21.5839 12.092 24.6969 11.449 27.2719 12.578L27.9679 12.046C27.8489 11.269 27.9909 10.449 28.4269 9.722C29.4229 8.065 31.5729 7.529 33.2299 8.524C34.8869 9.52 35.4229 11.669 34.4279 13.326C33.9679 14.09 33.2649 14.615 32.4759 14.863L31.7529 15.709L30.9089 15.147L31.6679 14.013C32.4279 13.939 33.1459 13.517 33.5699 12.811C34.2809 11.628 33.8989 10.093 32.7149 9.382C31.5319 8.67 29.9959 9.053 29.2849 10.237C28.8629 10.938 28.8259 11.763 29.1109 12.466L28.0629 14.21C25.7389 12.381 22.3659 12.717 20.4509 14.998L19.3379 16.677L19.5859 17.41" fill="#63b3f5" stroke="#63b3f5"/>
        ...
        <h1>Welcome back</h1>
        <p class="registration-subtitle">Sign up to access your mountain dashboard</p>
