      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="#about" :class="{ active: activeSection === 'about' }">About Us</a></li>
            <li><a href="#cards" :class="{ active: activeSection === 'cards' }">Where to Ski</a></li>
            ...
            <li><a href="#team" :class="{ active: activeSection === 'team' }">Team</a></li>
            <li><a href="#contact" :class="{ active: activeSection === 'contact' }">Contact</a></li>
            <li><router-link to="/login" class="nav-btn btn-login">Log In</router-link></li>
            <li><router-link to="/registration" class="nav-btn btn-register">Sign Up</router-link></li>
          </ul>
...
@media (min-width: 1200px) {
  ...
  .navmenu .dropdown ul {
    ...
    z-index: 99;
    border-radius: 8px;
    box-shadow: 0 8px 32px rgba(10, 30, 70, 0.4);
